(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/maskprefab.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '69a86PDG4dNQLkLs9RjOvoj', 'maskprefab', __filename);
// scripts/maskprefab.js
...
cc.Class({
    ...
    clickbtn: function clickbtn(event, customEventData) {
        var that = this;
    ...
    invitereward: function invitereward(event, customEventData) {
        var that = this;
        that.btnfinishNode.getComponent(cc.Animation).play('scale109');
        that.scheduleOnce(function () {
            var xhr = new XMLHttpRequest();
    ...
    addbtnevent: function addbtnevent(eventname, data) {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=maskprefab.js.map
