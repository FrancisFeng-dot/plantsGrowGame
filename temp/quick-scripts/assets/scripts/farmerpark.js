(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/scripts/farmerpark.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'b972dcw2/xL3bZWMPTp58C0', 'farmerpark', __filename);
// scripts/farmerpark.js
...
cc.Class({
    ...
    showshat: function showshat(event, customEventData) {
        var that = this;
    ...
    deenergy: function deenergy(hasenergy) {
        this.getenergyPool.put(hasenergy);
    },
    musicstatus: function musicstatus(event) {
        var that = this;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=farmerpark.js.map
